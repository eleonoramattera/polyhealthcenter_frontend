...
function SectionCounter() {
  ...
  return (
    <>
      <Row>
        <h4 className="text-center">I NOSTRI NUMERI</h4>
        <Col xs={12} className="d-flex justify-content-between mt-3 ">
          <div className="d-flex ms-5">
            <p>
              <AiFillMedicineBox className="sectionCounterIcons" />
            </p>
            <div className="ms-2">
          ...
          <div className="d-flex">
            <p>
              <FaPeopleRoof className="sectionCounterIcons" />
            </p>
            <div className="ms-2">
          ...
          <div className="d-flex me-5">
            <p>
              <FaHandHoldingMedical className="sectionCounterIcons" />
            </p>
            <div className="ms-2">
